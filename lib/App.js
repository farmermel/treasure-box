...
export default class App extends React.Component {
  ...
  filterByRating(rating) {
    this.onSearch('search');
    let treasuresToFilter = this.state.treasuresToRender;

    let treasuresToRender = treasuresToFilter.filter( treasure => {
      return treasure.rating === rating;
    });
  ...
  render() {
    console.log(this.state.treasuresToRender);
    return (
      <div className="App">
